...
../ECE231/scripts/cpplint.py --filter=-runtime/references,-whitespace/indent ../ECE231/homework${HW_NUMBER}/src/*.cpp ../ECE231/homework${HW_NUMBER}/include/homework${HW_NUMBER}/*.h 
